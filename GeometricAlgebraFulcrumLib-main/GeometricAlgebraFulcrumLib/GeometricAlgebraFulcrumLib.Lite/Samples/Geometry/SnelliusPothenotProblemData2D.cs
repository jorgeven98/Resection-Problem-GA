using System.Text;
using GeometricAlgebraFulcrumLib.Lite.LinearAlgebra.Float64.Angles;
using GeometricAlgebraFulcrumLib.Lite.LinearAlgebra.Float64.Vectors.Space2D;
using GeometricAlgebraFulcrumLib.Lite.ScalarAlgebra.Float64;
...
public readonly struct SnelliusPothenotProblemData2D
{
    ...
    ///// </summary>
    ///// <returns></returns>
    //public Float64Vector2D SolveUsingPGaPaco1()
    //{
    //    var cga = RGaConformalSpace4D.Instance;

    //    //var a = cga.EncodePGaPoint(A);
    //    var b = cga.EncodePGaPoint(B);
    //    //var c = cga.EncodePGaPoint(C);

    //    var lab = cga.EncodePGaLineFromPoints(A, B);
    //    var lcb = cga.EncodePGaLineFromPoints(C, B);

    //    var midAb = cga.EncodePGaBisectorLine(A, B);
    //    var midCb = cga.EncodePGaBisectorLine(C, B);

    //    var ra = cga.EncodePGaRotation(
    //        Float64PlanarAngle.Angle90 - Alpha, A
    //    );

    //    var rc = cga.EncodePGaRotation(
    //        Beta - Float64PlanarAngle.Angle90, C
    //    );

    //    var lao = ra.MapBlade(lab);
    //    var lco = rc.MapBlade(lcb);

    //    var o1 = lao.IntersectPGa(midAb).DecodePGaPoint2D();
    //    var o2 = lco.IntersectPGa(midCb).DecodePGaPoint2D();

    //    var l12 =
    //        cga.EncodePGaLineFromPoints(o1, o2);

    //    return b.ReflectIpnsOn(l12).DecodePGaPoint2D();
    //}
    ...
    ///// </summary>
    ///// <returns></returns>
    //public Float64Vector2D SolveUsingCGaPaco1()
    //{
    //    var cga = RGaConformalSpace4D.Instance;
    ...
    //    var da = ra.TranslateBy(A);
    //    var dc = rc.TranslateBy(C);
    ...
    //    var l12 =
    //        cga.EncodeOpnsFlatLineFromPoints(o1, o2);

    //    // Why is this negative ?!!
    //    var p =
    //        -b.ReflectIpnsOnOpns(l12).DecodeEGaVector2D();
